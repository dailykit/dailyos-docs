...
Inside the **Packagings** module, we can view all the created Packaging. Initially, the default packaging list view will be empty. To create a Packaging, click on the  **Add**  button in the top right corner of the screen.
