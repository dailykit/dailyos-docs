...
Now the supplier item has been created and added to the supplier item list. We can toggle on/off the availability of the supplier item using the **Toggle** button located in each supplier item row.
